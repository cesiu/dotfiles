...
\algnewcommand\DPDefn{\smallskip\item[\raisebox{0.5ex}{\,\tiny$\bullet$\!}\;\textit{Definition:}]}
\algnewcommand\DPBase{\smallskip\item[\raisebox{0.5ex}{\,\tiny$\bullet$\!}\;\textit{Base Cases:}]}
\algnewcommand\DPForm{\smallskip\item[\raisebox{0.5ex}{\,\tiny$\bullet$\!}\;\textit{Formula:}]}
\algnewcommand\DPSoln{\smallskip\item[\raisebox{0.5ex}{\,\tiny$\bullet$\!}\;\textit{Solution:}]}
